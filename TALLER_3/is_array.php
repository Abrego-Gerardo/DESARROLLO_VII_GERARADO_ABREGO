...
$miArray = ["Frutas", "Peliculas", "Nombres"]; // Reemplaza esto con tu propio array
$miString = "Gerardo"; // Reemplaza esto con tu propio string
$miNumero = 7567; // Reemplaza esto con tu propio número

echo "Resultados del ejercicio:";
