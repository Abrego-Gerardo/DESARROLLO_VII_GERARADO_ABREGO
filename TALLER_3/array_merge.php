...
$misComidas = ["Pastas", "Pizza", "Hamburguesas"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Salchipapa", "Tacos", "Ramen"]; // Reemplaza con las comidas favoritas de tu amigo
$todasLasComidas = array_merge($misComidas, $comidasAmigo);
echo "Todas las comidas favoritas:";
