...
echo "JSON de persona decodificado como array:";
print_r($persona);

// Ejercicio: Decodifica el JSON de tu película favorita del ejercicio anterior
$jsonPelicula = '{"titulo":"Star Wars La venganza da los Sith","director":"Gerge Lucas","año":2005,"actores":["Hayden Christensen","Ewan McGregor","Natalie Portman"]}';
$peliculaFavorita = json_decode($jsonPelicula, true);
echo "Información de tu película favorita decodificada:";
...
echo "JSON complejo decodificado:";
