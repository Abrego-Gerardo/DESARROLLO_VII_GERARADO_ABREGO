...
// 10. Mostrar el producto con mayor valor en inventario
list($productoMayor, $valorMayor) = productoMayorValor($inventario);
echo "\nProducto con mayor valor total en inventario: $productoMayor (Valor: $$valorMayor)\n";
