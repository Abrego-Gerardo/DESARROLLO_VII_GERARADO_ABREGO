...
function crecimientoVentas($ventas) {
    return (($ventas[count($ventas) - 1] - $ventas[0]) / $ventas[0]) * 100;
}
...
echo "Producto con mayor crecimiento: $productoConMayorCrecimiento en la región $regionConMayorCrecimiento (Crecimiento: " . number_format($maxCrecimiento, 2) . "%)\n";
?>
