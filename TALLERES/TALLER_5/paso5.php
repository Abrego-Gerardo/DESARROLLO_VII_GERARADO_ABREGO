...
$ventas = [
    ...
    ["producto_id" => 2, "cliente_id" => 102, "cantidad" => 2, "fecha" => "2023-09-05"],
    ["producto_id" => 3, "cliente_id" => 101, "cantidad" => 3, "fecha" => "2023-09-08"],
    ["producto_id" => 1, "cliente_id" => 103, "cantidad" => 1, "fecha" => "2023-09-10"],
    ["producto_id" => 4, "cliente_id" => 102, "cantidad" => 1, "fecha" => "2023-09-12"]
];
...
function generarResumenVentas($ventas, $productos, $clientes) {
    ...
    foreach ($ventas as $venta) {
        ...
        if (!isset($clientesCompradores[$venta["cliente_id"]])) {
            $clientesCompradores[$venta["cliente_id"]] = 0;
        }
        $clientesCompradores[$venta["cliente_id"]] += $venta["cantidad"];
    }
    ...
    $clienteMasCompradorId = array_search(max($clientesCompradores), $clientesCompradores);
    ...
    return [
        ...
        "cliente_mas_comprador" => $clienteMasComprador['nombre']
    ];
}
