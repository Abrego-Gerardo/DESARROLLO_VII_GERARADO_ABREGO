...
echo "Array de frutas en JSON:$jsonFrutas";
...
echo "Array asociativo de persona en JSON:$jsonPersona";
...
$peliculaFavorita = [
    "titulo" => "Star Wars La venganza del sith",
    "director" => "George Lucas",
    "año" => 2005,
    "actores" => ["Hayden Christensen", "Ewan McGregor", "Natalie Portman"]
];
$jsonPelicula = json_encode($peliculaFavorita);
echo "Información de tu película favorita en JSON:$jsonPelicula";
...
echo "Objeto Libro en JSON:$jsonLibro";
...
echo "JSON con opciones (caracteres Unicode y formato bonito):$jsonConOpciones";
?>